...
public class Icream_Food_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_icream_food);
        ...
        Cursor cursor = db.query(DatabaseHelperFood.TABLE_FOOD_ICECREAM,
                null, null, null, null, null, null);

        // Khởi tạo adapter và truyền vào cursor
        adapter = new Drink_Food_Adapter(this, cursor);
        listView = findViewById(R.id.list_icecream);
